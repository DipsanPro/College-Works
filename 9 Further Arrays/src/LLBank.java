...
public class LLBank {
    ...
    private static void makeDeposit(Scanner input) {
        ...
        System.out.println("Deposit successful. New balance: " + accounts[accountNum-1].getBalance());
    }
    ...
    private static void makeWithdrawal(Scanner input) {
        ...
        if (accounts[accountNum-1].withdraw(amount)) {
            System.out.println("Withdrawal successful. New balance: " + accounts[accountNum-1].getBalance());
        } else {
